...
export default function MapSection({ profile }: Props) {
  ...
  if (!hasCoords && !hasAddress) return null; // don't render if there's nothing to show
  ...
  return (
    <section className="px-4 mt-10" id="location">
      <h2 className={styles.sectionTitle}>Find Me</h2>

      <div className="grid gap-4 md:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-2xl overflow-hidden border border-[var(--color-muted)] shadow-sm">
          <iframe
        ...
        <div className="flex flex-col items-start justify-between bg-[var(--color-bg)] border border-[var(--color-muted)] rounded-2xl p-4 md:p-6 gap-3">
          <div>
