...
const RichTextEditor = dynamic(
  () => import('@/lib/frontend/common/RichTextEditor'),
  { ssr: false }
);

export default function SuperAdminSettingsPage() {
  const [form, setForm] = useState({
    appName: 'myeasypage Builder',
    logo: '',
    primaryColor: '#4f46e5',
    supportEmail: 'support@myeasypage.com',
    helpCenter: 'https://myeasypage.com/help',
    seoTitle: 'Build beautiful bio links | myeasypage',
    seoDescription: 'myeasypage helps you create powerful personal bio link websites with zero code.',
    emailFromName: 'myeasypage Team',
    emailFromAddress: 'noreply@myeasypage.com',
    emailFooter: 'You’re receiving this because you signed up at myeasypage.',
    footerText: 'Made with ❤️ by myeasypage',
    copyright: '© 2025 myeasypage Technologies Pvt. Ltd.',
    facebook: '',
    twitter: '',
    linkedin: '',
    customJs: '',
